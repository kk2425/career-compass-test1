...
const App: React.FC = () => {
    ...
    useEffect(() => {
        // Check for the API key from environment variables using Vite's standard method.
        if (!import.meta.env.VITE_API_KEY) {
            setApiKeyMissing(true);
            console.warn("VITE_API_KEY environment variable not set in .env file. AI features will be unavailable.");
        }
    }, []);
                     ...
                     return (
                         <div className="w-full max-w-2xl mx-auto p-8 bg-slate-800 rounded-xl shadow-2xl text-center">
                             ...
                             <p className="text-slate-300">
                                 The AI-powered personalization step cannot proceed because the <code>VITE_API_KEY</code> is not configured in your <code>.env</code> file.
        ...
        <div className="min-h-screen bg-slate-900 text-slate-100 font-sans flex flex-col items-center p-4 sm:p-6 lg:p-8">
             {apiKeyMissing && (
                <div 
                    ...
                    role="alert"
                >
                    Warning: AI features are disabled. The <code>VITE_API_KEY</code> is not configured.
                </div>
            )}
